...
export default function AnalFissurePage() {
    return (
        <>
            ...
            {/* Banner Section */}
            <BariatricBanner
                title="Anal fissure, anal fistula"
                imageSrc="/img/bannerslider/Anal fissure 2.webp"
            />
            ...
            <Container className="my-5">
                ...
                <Row className="align-items-center">
                    ...
                    <Col lg={4} md={4} className="mb-4 d-flex justify-content-center">
                        <Image
                            src="/img/bannerslider/Anal fissure.webp"
                            alt="Anal fissure, anal fistula"
                            width={400}
                            height={300}
                ...
                <Row>
                    <Col lg={12} md={12}>
                        <p className="text-justify">
                            ...
                            Here's an overview of how laser surgery is used to treat common anorectal conditions like anal fissures.
                        </p>
                        <h4>Anorectal Conditions Treated with Laser Surgery</h4>

                        {/* Anal Fissures */}
                        <h6>1. Anal Fissures</h6>
                        <p className="text-justify">
                        ...
                        {/* Hemorrhoids */}
                        <h6>2. Hemorrhoids: Laser Hemorrhoidoplasty (LHP)</h6>
                        <p className="text-justify">
                            This procedure is used for treating internal hemorrhoids. A laser fiber is introduced into the hemorrhoidal pile, and laser energy is delivered, causing the hemorrhoid to shrink.
                        ...
                        <ul>
                            ...
                            <li><strong>Benefits:</strong> Minimal bleeding, less post-operative pain, quicker recovery compared to conventional hemorrhoidectomy.</li>
                        </ul>

                        {/* Fistula-in-Ano */}
                        <h6>3. Fistula-in-Ano</h6>
                        <p className="text-justify">
                            Many types of Laser, like LAFT, FILAC, DLPS, Fixicision, VAAFT are used to ablate the fistula tract from within.
