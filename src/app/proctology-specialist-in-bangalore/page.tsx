...
export default function ProctologySpecialistPage() {
  return (
    <>
      ...
      <div className="new-proctology-page">
        <BariatricBanner
          title="Proctology"
          imageSrc="/img/bannerslider/Obesity 2.webp"
        />

        <Container className="my-5 new-proctology-main">
          <Row className="new-proctology-row-animate">
            <Col lg={4} md={4} className="mb-4 d-flex justify-content-center new-proctology-img-section">
              <Image
