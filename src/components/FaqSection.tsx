...
const faqsData = [
  ...
  },
  {
    ...
    answer:
      'Common risks include infection, blood clots, and nutritional deficiencies. It is important to follow post-surgery care instructions closely to minimize these risks and ensure a smooth recovery.',
  },
];
const FAQSection: React.FC<FAQSectionProps> = ({ faqs = faqsData }) => {
  const [count, setCount] = useState(0);
  const target = 95;

  // Optional counter effect (kept from your code)
  useEffect(() => {
    let start = 0;
    const end = target;
